...
class TestTelegramBot(unittest.TestCase):
    ...
    @patch.object(TelegramBot, 'send_message')
    def test_handle_command_chatmode_enable(self, mock_send):
        """Test enabling chat mode"""
        with patch.object(self.bot, 'db') as mock_db:
    ...
    @patch.object(TelegramBot, 'send_message')
    def test_handle_command_chatmode_disable(self, mock_send):
    ...
    def test_handle_message_with_chatmode_enabled(self, mock_handle_text):
    ...
    @patch.object(TelegramBot, '_handle_text_message')
    def test_handle_message_with_chatmode_disabled(self, mock_handle_text):
    ...
    def test_handle_message_commands_always_processed(self, mock_handle_cmd):
    ...
    def test_handle_message_voice_ignored_when_chatmode_enabled(self, mock_handle_voice):
